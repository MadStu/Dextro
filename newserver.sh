...
echo "dxouser:$PASS" | chpasswd
usermod -aG sudo dxouser
...
echo "              reboot"
echo " "
echo " Then log back in with your new dxouser account to complete the installation."
echo " "
